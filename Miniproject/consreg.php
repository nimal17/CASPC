...
<div id="div1"> 
  ...
  <form class="form" action="" method="post" enctype="multipart/form-data"style="background-color:#FFCDD2" style="margin-top:0px;">
        <h1 class="login-title">Consumer Registration</h1>
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($user) { // if user exists
           ...
           echo "<div class='form'>
                  ...
                  <p class='link'>Click here to <a href='consreg.php'>Register</a></p>
                  </div>";
           }
        }
        if (count($errors) == 0) {
