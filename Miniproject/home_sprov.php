    ...
    <div class="row ">
        <div class="col-sm-1 bg-dark sidebar py-5 ">
            <div class="sidebar-sticky">
                ...
                href="profile.php"><i class="fas fa-user fa-4x"></i>Profile</a></li>

                <!-- <li class="nav-item"><a class="nav-link" -->
                <!-- href="addservice.php"><i class="fab fa-accessible-icon fa-4x"></i>Add Service</a></li> -->

                <li class="nav-item"><a class="nav-link"
                href="spservhist.php"><i class="fas fa-history fa-4x"></i>Service</a></li>
